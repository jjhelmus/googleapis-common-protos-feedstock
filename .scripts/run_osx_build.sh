...
validate_recipe_outputs "googleapis-common-protos-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="googleapis-common-protos-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi